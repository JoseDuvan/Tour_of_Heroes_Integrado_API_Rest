...
export class HeroService {
  ...
  getHeroNo404<Data>(id: number): Observable<Hero> {
    const url = `http://localhost:8080/heroes-api/tour-heroes/consultar404/${id}`;
  ...
  getHero(id: number): Observable<Hero> {
    const url = `http://localhost:8080/heroes-api/tour-heroes/${id}`;
  ...
  searchHeroes(term: string): Observable<Hero[]> {
    ...
    return this.http.get<Hero[]>(`http://localhost:8080/heroes-api/tour-heroes/BuscarPorNombre/${term}`).pipe(
